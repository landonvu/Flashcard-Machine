...
How to download
-------------------------------------------------------------------    
    First, download python here: https://www.python.org/downloads/

    Next, click on the following link: https://github.com/landonvu/Flashcard-Machine/blob/main/Flashcard-Machine.py (This is the link to view the code)
